...
Tu montes des vidéos pour le **Dr Fabrice BAUDOT** (IMCP — Institut
...
| Préférences + corrections + exemples validés | `praticiens/baudot.json` |
...
5. **RENDRE SANS AVOIR APPELÉ LE PORTAIL EST INTERDIT.** Pas « recommandé » :
   interdit. Un rendu coûte 6 minutes de machine et des jetons ; le portail
...
`praticiens/baudot.json`, sinon la leçon est perdue :
